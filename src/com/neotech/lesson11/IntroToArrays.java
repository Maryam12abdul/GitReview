...
public class IntroToArrays {
	...
	public static void main(String[] args) {
		...
		//initialize syntax: 1- new keyword, data type (int), size ([5]) 
		...
		//be default all integer array elements are initialized to 0
...
//				System.out.println(array1[5]); //we don't have an index 5 (the highest is 4)
